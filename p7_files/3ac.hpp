#ifndef DREWGON_3AC_HPP
#define DREWGON_3AC_HPP
...
class IntrinsicMayhemQuad : public Quad{
public:
	IntrinsicMayhemQuad(Opd * dst);
	std::string repr() override;
