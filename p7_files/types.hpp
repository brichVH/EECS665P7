#ifndef DREWGON_DATA_TYPES
#define DREWGON_DATA_TYPES
...
//This class is the superclass for all drewgon types. You
...
//This DataType subclass is the superclass for all drewgon types.
...
public:
	...
	std::string getString() const override{
		std::string result = "";
		bool first = true;
		for (auto elt : *myFormalTypes->getTypes()){
			if (first) { first = false; }
			else { result += ","; }
