...
/**
 ** \file grammar.hh
 ** Define the drewgon::parser class.
 */
...
#line 253 "grammar.hh"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_MAYHEM = 26,                           // MAYHEM
        S_NOT = 27,                              // NOT
        S_NOTEQUALS = 28,                        // NOTEQUALS
        S_OR = 29,                               // OR
        S_OUTPUT = 30,                           // OUTPUT
        S_PLUS = 31,                             // PLUS
        S_POSTDEC = 32,                          // POSTDEC
        S_POSTINC = 33,                          // POSTINC
        S_RETURN = 34,                           // RETURN
        S_RCURLY = 35,                           // RCURLY
        S_RPAREN = 36,                           // RPAREN
        S_SEMICOL = 37,                          // SEMICOL
        ...
        S_type = 47,                             // type
        S_primType = 48,                         // primType
        S_fnType = 49,                           // fnType
        S_typeList = 50,                         // typeList
        S_fnDecl = 51,                           // fnDecl
        S_formals = 52,                          // formals
        S_formalDecl = 53,                       // formalDecl
        S_stmtList = 54,                         // stmtList
        S_blockStmt = 55,                        // blockStmt
        S_stmt = 56,                             // stmt
        S_exp = 57,                              // exp
    ...
    Parser (drewgon::Scanner &scanner_yyarg, drewgon::ProgramNode** root_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    // User arguments.
    drewgon::Scanner &scanner;
    drewgon::ProgramNode** root;
