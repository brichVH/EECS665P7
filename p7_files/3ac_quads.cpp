...
std::string drewgon::IntrinsicInputQuad::repr(){
	return "RECEIVE " + myArg->valString();
}

IntrinsicMayhemQuad::IntrinsicMayhemQuad(Opd * dst)
: myDst(dst){ }

std::string drewgon::IntrinsicMayhemQuad::repr(){
	return "MAYHEM " + myDst->valString();
}
